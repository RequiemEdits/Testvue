<template>
  <nav class="navbar-navbar" v-bind:class="rootClassName">
    ...
    <div id="mobile-menu" class="navbar-mobile-menu">
      ...
      <div class="get-started"><span class="navbar-text">Get started</span></div>
    </div>
    <div>
      <DangerousHTML
        html="<script>
...
export default {
  ...
  props: {
    ...
    BrandingLogo: {
      type: String,
      default: '/playground_assets/dde-200h.png',
    },
  },
  components: {
    DangerousHTML,
